<script lang="ts">
  ...
  let useDbColSelect = $derived(
    sheet.action === "append" && !!sheet.tableName && sheet.dbColumns != null,
  );
</script>
    ...
    <Table.Root>
      <Table.Header>
        <Table.Row>
          ...
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 whitespace-nowrap">Col Type</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900">Config</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 text-center w-12">Excl.</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 whitespace-nowrap">DB Column</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 whitespace-nowrap">DB Type</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 w-20">Length</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 w-20">Precision</Table.Head>
          <Table.Head class="border bg-gray-100 dark:bg-gray-900 w-20">Scale</Table.Head>
        </Table.Row>
      </Table.Header>
      <Table.Body>
        {#each sheet.columns as column, i}
          {@const modifiers = TYPE_MODIFIERS[column.dataType] ?? {}}
          <Table.Row>
